            ...
            <table  border='1' cellpadding='10'>
                ...
                <?php while ($row = $q->fetch()): ?>
                    <tr>
                        ...
                        <td><a href="aanpassen_bestellingen.php?bestelling_ID=<?php echo $row['bestelling_ID'] ?>">aanpassen</a></td>
                        <td><a href="verwijderen_bestellingen.php?bestelling_ID=<?php echo $row['bestelling_ID'] ?>">X</a></td>
                    </tr>
                <?php endwhile; ?>
                </tbody>
            </table>
